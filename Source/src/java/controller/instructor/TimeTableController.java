 ...
 * @author MinhDuy
 */
public class TimeTableController extends BaseRequiredAuthenticationTeacher {
...
//edit code to adjust for instructor
        LectureDBContext lectureDB = new LectureDBContext();
        ArrayList<Lecture> listLectures = lectureDB.getByDateInstructor(fromTo.get(0), fromTo.get(1), u.getInstructor().getInstructorID());
